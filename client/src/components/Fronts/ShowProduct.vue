        ...
        <div v-if="product" >
            <div class="hero-wrapper">
                <div class="hero">
                    ...
                    <h1>Webblot from nodejs + vuejs Eproduct</h1>
                    <p>By Gooddev.ME</p>
                </div>
            </div>
            <div class="product-wrapper" v-if="product != null">
                <h1>{{ product.title }}</h1>
                <p><strong>Category: </strong>: <a href="#" v-on:click.prevent="navigateTo(`/front?search=${product.category}`)">{{product.category }}</a></p>
